...
import type GnosisSafeProxyFactoryEthersContract from 'gnosis-neon-safe-ethers-lib/dist/src/contracts/GnosisSafeProxyFactory/GnosisSafeProxyFactoryEthersContract'
