...
import { SafeAppSocialPlatforms } from '@neonlabs-devops/gnosis-neon-gateway-typescript-sdk'
import type { SafeAppData, SafeAppSocialProfile } from '@neonlabs-devops/gnosis-neon-gateway-typescript-sdk'
