...
import type { GasPrice, GasPriceOracle } from '@neonlabs-devops/gnosis-neon-gateway-typescript-sdk'
import { GAS_PRICE_TYPE } from '@neonlabs-devops/gnosis-neon-gateway-typescript-sdk'
